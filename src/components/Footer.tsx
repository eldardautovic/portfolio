        ...
        <footer className="flex flex-col justify-centert">
            ...
            <div className="flex justify-between">
                <div className="flex items-center">
                    <Link href="https://github.com/eldardautovic" target="_blank"><GithubIcon width={25} height={25}
                                                                                              className="text-slate-400 hover:text-slate-300"/></Link>
                    <Link href="https://www.linkedin.com/in/eldardautovic/"><LinkedinIcon width={25}
                                                                                          height={25}
                                                                                          className="text-slate-400 hover:text-slate-300"/></Link>
                </div>
